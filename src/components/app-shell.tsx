...
import { BookOpenCheck, BriefcaseBusiness, CalendarClock, FolderKanban, Inbox, LayoutDashboard, LogOut, Send, SquarePen } from "lucide-react";
import { signOut } from "@/app/sign-in/actions";

type ActiveView = "dashboard" | "inbox" | "sent" | "scheduled" | "projects" | "jobs" | "career" | "compose";
const navigation = [
