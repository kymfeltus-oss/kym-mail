...
export default function SignInPage() {
  return <main className="grid min-h-screen place-items-center px-5 py-10"><div className="w-full max-w-md">
    ...
    <section className="glass rounded-3xl p-7 sm:p-9"><p className="text-xs font-semibold uppercase tracking-[.22em] text-[#D95B72]">Owner access</p><h1 className="mt-3 text-3xl font-semibold tracking-tight text-[#183A5A]">Welcome back.</h1><p className="mt-3 text-sm leading-6 text-[#64748B]">Sign in to your private KYM Mail workspace.</p><SignInForm /><p className="mt-6 text-center text-sm text-[#64748B]">Booking a consultation? <Link href="/consult" className="font-semibold text-[#D95B72]">Open the public booking page</Link></p></section>
  </div></main>;
}
