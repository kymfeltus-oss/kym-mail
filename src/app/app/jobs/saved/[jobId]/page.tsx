...
import { ArrowLeft, Building2, CalendarDays, ExternalLink, MapPin, WalletCards } from "lucide-react";
...
export default async function SavedJobPage({ params }: { params: Promise<{ jobId: string }> }) {
