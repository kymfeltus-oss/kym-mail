...
type Experience = { id: string; canonical_key: string; organization_id: string; client_organization_id: string | null; title_id: string | null; start_date: string | null; end_date: string | null; is_current: boolean; summary: string | null; completeness: "COMPLETE" | "PARTIAL"; authority_status: string };
...
function formatMonth(value: string | null, current = false) {
...
export default async function CareerProfilePage() {
  ...
  const [profileResult, organizationsResult, titlesResult, experiencesResult, educationResult, credentialsResult, skillsResult, projectsResult, accomplishmentsResult, metricsResult, aliasesResult, sourcesResult, provenanceResult] = await Promise.all([
    ...
    database.from("career_experiences").select("id, canonical_key, organization_id, client_organization_id, title_id, start_date, end_date, is_current, summary, completeness, authority_status").eq("owner_id", ownerId).order("start_date", { ascending: false, nullsFirst: false }),
